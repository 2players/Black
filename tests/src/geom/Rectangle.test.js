import { Rectangle, Vector } from './../../../dist/es6-module'
...
describe('Rectangle', () => {
  ...
  test('Should return a string representation of this rectangle', () => {
    ...
    expect(r.toString()).toBe(
      'Rectangle { x: 10.00, y: 20.00, width: 0.00, height: 0.00 }'
    )
    expect(r.toString(20)).toBe(
      'Rectangle { x: 10.00000000000000000000, y: 20.00000000000000000000, width: 0.00000000000000000000, height: 0.00000000000000000000 }'
    )
  })
})
